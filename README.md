# How to Change the Month Header Format in the .NET MAUI Calendar (SfCalendar)
This repository contains a sample to change the month header format in the [Syncfusion .NET MAUI Calendar](https://help.syncfusion.com/maui/calendar/getting-started) control.

Please refer the KB through this [link](https://www.syncfusion.com/kb/13889/how-to-change-the-month-header-format-in-the-net-maui-calendar-sfcalendar).
